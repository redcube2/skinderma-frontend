...
export async function GET() {
  ...
  const lines: string[] = [
    ...
    ``,
    `## Právne dokumenty a spotrebiteľské práva`,
    ``,
    `> Všetky právne dokumenty žijú na apexe (WordPress) – to sú kanonické URL.`,
    ``,
    `- [Obchodné podmienky](${APEX}/obchodne-podmienky/)`,
    `- [Reklamačný poriadok](${APEX}/reklamacny-poriadok/)`,
    `- [Zásady ochrany osobných údajov](${APEX}/zasady-ochrany-osobnych-udajov/)`,
    `- [Odstúpenie od zmluvy – online formulár](${APEX}/odstupenie-od-zmluvy/)`,
    `- [Vzorový formulár na odstúpenie od zmluvy](${APEX}/vzorovy-formular-na-odstupenie-od-zmluvy/)`,
    `- [Reklamácia – online formulár](${APEX}/reklamacia/)`,
    ``,
    `## Produkty a e-shop`,
    ``,
