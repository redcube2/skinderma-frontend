...
/**
 * Locale-aware contact form. Same wire format and /api/contact endpoint as the
 * Slovak app/kontakt/ContactForm.tsx — only the visible copy is parametrised.
 */
export default function ContactForm({ dict }: { dict: ContactFormDict }) {
  const subjects = dict.subjects.length > 0 ? dict.subjects : ["—"];
